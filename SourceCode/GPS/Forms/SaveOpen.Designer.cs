...
namespace AgOpenGPS
{
    ...
    public partial class FormGPS
    {
        ...
        public void FileSaveCurveLines()
        {
            ...
            string dirField = Path.Combine(fieldsDirectory,  currentFieldDirectory) + Path.DirectorySeparatorChar;
        ...
        public void FileCreateField()
        {
            ...
            //get the directory and make sure it exists, create if not
            dirField = Path.Combine(fieldsDirectory, currentFieldDirectory) + Path.DirectorySeparatorChar;
            string directoryName = Path.GetDirectoryName(dirField);
